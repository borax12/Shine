...
import borax12.com.shine.MainActivity;
...
public class ShineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,String locationSetting)throws JSONException {
        ...
        try {
            ...
            Log.d(LOG_TAG, "FetchWeatherService Complete. " + cVVector.size() + " Inserted");
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor locationCurosr = mContext.getContentResolver().query(
        ...
        if(locationCurosr.moveToFirst()){
            int locationIdIndex = locationCurosr.getColumnIndex(WeatherContract.LocationEntry._ID);
            locationId=locationCurosr.getLong(locationIdIndex);
        }
        else{
                ...
                if (cursor.moveToFirst()) {
                    ...
                    NotificationCompat.Builder mBuilder =
                            new NotificationCompat.Builder(getContext())
                                    .setColor(resources.getColor(R.color.shine_light_blue))
